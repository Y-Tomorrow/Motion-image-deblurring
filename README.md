...
其中 $N$ 为像素总数，$MAX$ 为像素最大值（8 位图像取 255）。
...
![对照组：原始模糊](image/image_1.png)

## 2 基础组

### 均值滤波

![均值滤波](image/image_2.png)

### 中值滤波

![中值滤波](image/image_3.png)

### 高斯滤波

![高斯滤波](image/image_4.png)

### 巴特沃斯低通（只跑100张）  

![巴特沃斯低通](image/image_5.png)

### 巴特沃斯高通（只跑100张）

![巴特沃斯高通](image/image_6.png)

### 理想低通（只跑100张） 

![理想低通](image/image_7.png)

### 理想高通（只跑100张）

![理想高通](image/image_8.png)
...
![HAP-Deblur](image/image_9.png)

### NRC-HybridNet

模型：MIMO-UNet.pkl

![NRC-HybridNet 预训练权重](image/image_10.png)

模型：自训练best.pth

![自训练 best.pth 训练](image/train_model.png)
![NRC-HybridNet 自训练权重](image/image_11.png)
